...
class _$RegisterResponseImpl implements _RegisterResponse {
  const _$RegisterResponseImpl({required this.refresh, required this.access});
  ...
  @override
  String toString() {
    return 'RegisterResponse(refresh: $refresh, access: $access)';
  }
...
abstract class _RegisterResponse implements RegisterResponse {
  const factory _RegisterResponse(
      ...
      required final String access}) = _$RegisterResponseImpl;
