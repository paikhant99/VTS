...
abstract class AppointmentRepository{
   Future<Result<List<TimeSlot>,Exception>> getAvailableTimeSlots(String token);
...
class AppointmentRepositoryImpl extends AppointmentRepository{
  ...
  @override
  Future<Result<List<TimeSlot>,Exception>> getAvailableTimeSlots(String token)async{
    Response response = await _apiService.getAvailableTimeSlots(RequestHeader(contentType: VTSApp.APP_JSON, acceptType: VTSApp.APP_JSON, authorization: "{Bearer : $token}"));
